...
<body>
    <form id="form1" runat="server">
                ...
                <td class="auto-style5">Usuario<table class="auto-style1">
                    <tr>
                        <td class="auto-style10">
                            <asp:HyperLink ID="HyperLink1" runat="server">Agregar detalle de venta</asp:HyperLink>
                        </td>
                        <td class="auto-style11">
                            <asp:HyperLink ID="HyperLink2" runat="server">Eliminar detalle de venta</asp:HyperLink>
                        </td>
                        <td class="auto-style9">
                            <asp:HyperLink ID="HyperLink3" runat="server">Buscar detalle de venta</asp:HyperLink>
                        </td>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style13">Ingrese código del detalle de venta: </td>
