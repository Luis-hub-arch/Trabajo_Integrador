...
namespace Dao
{
    public class DaoProveedores
    {
        ...
        private void ArmarParametroProveedorAgregar(ref SqlCommand Comando, Proveedor Prov)
        {
            ...
            //SqlParametros = Comando.Parameters.Add("@Cod_Proveedor_Pr", SqlDbType.Int);
            ...
            SqlParametros = Comando.Parameters.Add("@Ciudad", SqlDbType.VarChar);
            SqlParametros.Value = Prov.GetCiudad();
            SqlParametros = Comando.Parameters.Add("@Provincia", SqlDbType.VarChar);
            SqlParametros.Value = Prov.GetProvincia();
            SqlParametros = Comando.Parameters.Add("@Cuit", SqlDbType.Int);
            ...
            SqlParametros = Comando.Parameters.Add("@Contacto", SqlDbType.Int);
            SqlParametros.Value = Prov.GetContacto();
            SqlParametros = Comando.Parameters.Add("@Web", SqlDbType.VarChar);
            ...
            SqlParametros = Comando.Parameters.Add("@Cbu", SqlDbType.Int);
